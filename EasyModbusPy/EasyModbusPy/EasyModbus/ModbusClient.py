...
import ModbusException as Exceptions #@UnresolvedImports
...
def ConvertDoubleToTwoRegisters(doubleValue):
    """
...
def ConvertFloatToTwoRegisters(floatValue):
    """
...
def ConvertRegistersToDouble(registers) :
    """
...
def ConvertRegistersToFloat(registers):
    """
